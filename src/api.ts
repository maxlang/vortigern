...
// getEmojis().then((v) => console.log('worked!', v)).catch((e) => console.log('still worked!!!', e));

// // TODO: send your current location to track and only track emoji/locations nearby
// router.ws('/track', async (ws) => {
//   tracking.push(ws);
//   const body = {
//     size: 0,
//     aggs: {
...
//     },
//   };
//   console.log('track await before');
//   console.log('track await', await getEmojis());
